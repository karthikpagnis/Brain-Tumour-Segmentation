# Google Colab Setup and Training Guide

Complete guide to run Brain Tumor Segmentation in Google Colab with free GPU access.
...
**This creates synthetic data (approximately 500MB) for quick testing**
...
**For large datasets (approximately 150 GB):**
...
| Cannot Download Dataset | Use --create_mock flag to generate synthetic data instead |
...
|---------|------|----------|
| Mock (20 cases) | Approximately 500 MB | Instant (generated) |
| Mock (100 cases) | Approximately 2.5 GB | 5 minutes |
| Real BraTS (full) | Approximately 150 GB | 2-4 hours |
| Real BraTS (100 cases) | Approximately 50 GB | 45 minutes |
...
- T4 GPU: Approximately 1 epoch = 3-4 minutes (50 epochs = 2-3 hours)
- P100 GPU: Approximately 1 epoch = 2 minutes (50 epochs = 1.5-2 hours)
- V100 GPU: Approximately 1 epoch = 1.5 minutes (50 epochs = 1-1.5 hours)
- A100 GPU: Approximately 1 epoch = 1 minute (50 epochs = 50 minutes)
...
1. Run mock dataset training first (10-15 minutes)
...
Working in Colab? You are ready to train.
